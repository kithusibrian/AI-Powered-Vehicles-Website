...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Kai and Karo Limited',
    "address" TEXT NOT NULL DEFAULT 'Westlands Business Park, Nairobi, Kenya',
    "phone" TEXT NOT NULL DEFAULT '+254 716 770 077',
    "email" TEXT NOT NULL DEFAULT 'kaiandkaro@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
